...
_PCM_prototype.prototype = {
    ...
    initialize: function() {
        try {
            ...
            _PCM.createMd5(this);
            console.log("pageEvents=" + JSON.stringify(this.eventsBucket.pageEvents));
            ...
            console.log("->>>>pageEventsBucket=" + JSON.stringify(pageEventsBucket));
            ...
            console.log(">>>this.eventsBucket.allEvents=" + JSON.stringify(this.eventsBucket.allEvents));
            ...
            console.log(">>>eventsBucket=" + JSON.stringify(eventsBucket));
    ...
    returnDataLayerValue: function (objectString) {
        try {
          console.log("in returnDataLayerValue");
    ...
    verifyDataLayerObject: function (objectString){
        try {
          console.log("in verifyDataLayerObject");
            if (typeof objectString == "string") {
                var items = objectString.split(".");
                var object = "window";
                for (var i = 0; i < items.length; i++) {
    ...
    initializeTools: {
        ga: function(pageEvents) {
            try {
              console.log("in initializeTools");
                // install GA script
    ...
    log: function(message, type) {
        try {
          console.log("in log, debug=" + _PCM_settings.settings.debug);
    ...
    attachToElement: function (element, eventData) {
        try {
          console.log("in attachToElement");
    ...
    listenerHandler: function (eventAction, element, eventData) {
      console.log("in listenerHandler");
    ...
    sendEventsToParent: function(targetNode, eventObj) {
      console.log("in sendEventsToParent");
        try {
    ...
    processPendingIdentityCall: function () {
      console.log("in processPendingIdentityCall");
        try {
            var identitySet = _PCM.cookie.get('_pcm_identity');
            console.log("identitySet=" + identitySet);
    ...
    processUnmatchedPageEvents: function () {
      console.log("in processUnmatchedPageEvents");
        try {
    ...
    processPageEvents: function (events) {
      console.log("in processPageEvents, events=" + JSON.stringify(events));
        try {
            if (_PCM.verifyObject("Array.isArray")) {
    ...
    send: {
        ...
        googleAnalytics: {
            pageView: function (response) {
              console.log("in send, googleAnalytics, pageView");
                try {
    ...
    trackPageEvent: {
        ...
        googleAnalytics: function (event) {
          console.log("in trackPageEvent, googleAnalytics");
            try {
    ...
    trackPageView: {
        ...
        googleAnalytics: function (event) {
          console.log("in trackPageView, googleAnalytics");
            try {
    ...
    trackEvent: {
        ...
        popcornmetrics: function(eventObj, propertiesObj) {
          console.log("in trackEvent, popcornmetrics");
            try {
    ...
    createNewObject: function(object) {
      console.log("in createNewObject");
        try {
            var newObject = {};
    ...
    unpack: {
        customProperties: function (eventPackage) {
          console.log("in unpack customProperties");
            try {
        ...
        specialProperties: function (eventPackage) {
          console.log("in unpack specialProperties");
            try {
        ...
        userProperties: function (eventPackage) {
          console.log("in unpack userProperties");
            try {
                if (eventPackage) {
        ...
        dimensions: function (eventPackage) {
          console.log("in unpack dimensions");
            try {
        ...
        eventProperties: function(targetNode, eventObj) {
          console.log("in unpack eventProperties");
            try {
        ...
        revenueValues: function(customProperties, specialProperties) {
          console.log("in unpack revenueValues");
            try {
        ...
        identityIds: function (object) {
          console.log("in unpack identityIds");
            try {
                var ids = [];
                for (item in object) {
    ...
    getUserIdfromCookie: function() {
      console.log("in getUserIdfromCookie");
        try {
    ...
    get: {
        pcm: {
            domainId: function() {
              console.log("in get->pcm->domainId");
                try {
            ...
            sessionProperties: function() {
              console.log("in get->pcm->sessionProp");
                try {
                    var sBrowser = _PCM.getBrowserName();
                    var oSName   = _PCM.getOSName();
    ...
    checkForParentAnchorTag: function(el) {
      console.log("in checkForParentAnchorTag");
        try {
            // Check if element is inside a link (e.g. an image inside a link)
            // NOTE: If no link or form found, stops at BODY
    ...
    setPcmTrackAttribute: function(element) {
      console.log("in setPcmTrackAttribute");
        try {
    ...
    checkIfContainsIdFields: function (properties) {
      console.log("in checkIfContainsIdFields");
        try {
    ...
    createUserCredentials: function(user){
      console.log("in createUserCredentials");
        try {
    ...
    getMultipleElementsContainer: function (targetNode, parentContainerObj) {
      console.log("in getMultipleElementsContainer");
        try {
    ...
    getElementsValues: function(objects, targetNode, parentContainerObj) {
      console.log("in getElementsValues");
        try {
    ...
    checkEmailRegex: function(email){
      console.log("in checkEmailRegex");
        try {
    ...
    respondiFrameMessage: function(e){
      console.log("in respondiFrameMessage");
        try {
    ...
    cacheBustingTimestamp: function() {
      console.log("in cacheBustingTimestamp");
        try {
            var date = new Date();
    ...
    getEditorLib: function(e, debug){
      console.log("in getEditorLib");
        try {
            ...
            function editorLib(u, debug){
                ...
                if (debug) {
                    if (window.location.origin.indexOf("https") !== 0) {
                        p = '//engine.popcornmetrics.com/';
                    }
                    u = 'lib/v2/dev/Luis/editorlib.js';
                }
            ...
            editorLib('lib/v2/editorlib.min.js', debug);
    ...
    whenTagAvailable: function (tag, callback) {
      console.log("in whenTagAvailable");
        try {
            var interval = 10;
            window.setTimeout(function() {
    ...
    messageEventListener: function(callback) {
      console.log("in messageEventListener");
	    try {
        console.log("in messageEventListener!"); // callback=" + callback);
    ...
    setNavigationDelay: function() {
      console.log("in setNavigationDelay");
        try {
    ...
    filterPageEventsBucket: function(bucket) {
      console.log("in filterPageEventsBucket, bucket=" + JSON.stringify(bucket));
        try {
    ...
    filterEventsBucket: function(bucket) {
      console.log("in filterEventsBucket");
        try {
            var currentPathBucket = [];
    ...
    createMutationObserver: function() {
      console.log("in createMutationObserver");
        try {
    ...
    processMutationsQueue: function (id, mutations, scope) {
      console.log("in processMutationsQueue");
        try {
            (function next() {
    ...
    processMutation: function (callback, mutation) {
      console.log("in processMutation");
        try {
    ...
    checkChildNodesRecursively: function(nodes, eventsBucket) {
      console.log("in checkChildNodesRecursively");
        try {
    ...
    checkRemovedNodesRecursively: function(nodes) {
      console.log("in checkRemovedNodesRecursively");
        try {
            for (var i=0, node; node = nodes[i]; i++) {
    ...
    attachToElementsRendered: function(eventsBucket, scope){
      console.log("in attachToElementsRendered");
        try {
    ...
    checkUnmatchedEvents: function(events) {
      console.log("in checkUnmatchedEvents");
        try {
    ...
    assignMatchPath: function (type) {
      console.log("in assignMatchPath");
        try {
            if (type.query) {
    ...
    getPathObj: {
        path: function() {
          console.log("in getPathObj->path");
            try {
        ...
        query: function() {
          console.log("in getPathObj->query");
            try {
        ...
        hash: function() {
          console.log("in getPathObj->hash");
            try {
    ...
    checkIfPathHasChanged: function() {
      console.log("in checkIfPathHasChanged");
        try {
    ...
    supportedBrowser: function(){
      console.log("in supportedBrowser");
        try {
            // Allowed Versions
            // Internet Explorer >= 9
            // Chrome >= 4
